...
temp_color_surf = surface_create(73,73);
surface_set_target(temp_color_surf);
draw_clear_alpha(c_white,0);
...
//test_color_surf[i] = surface_create(73,73);
surface_set_target(temp_color_surf);
//draw_clear_alpha(c_white,0);
...
if temp_index = 0{
temp_sprite = sprite_create_from_surface(temp_color_surf,0,0,73,73,0,0,36,51);}else{
