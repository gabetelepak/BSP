...
button[islot,button_LT] = gamepad_button_check(gamepad[islot], gp_shoulderlb);
button[islot,button_RT] = gamepad_button_check(gamepad[islot], gp_shoulderrb);
...
button[islot,button_X] = max(gamepad_button_check(gamepad[islot], gp_face3),button[islot,button_LT],keyboard_check(ord('Q')));
button[islot,button_B] = max(gamepad_button_check(gamepad[islot], gp_face2),button[islot,button_RT],keyboard_check(ord('E')));
...
button[islot,button_X] = max(gamepad_button_check(gamepad[islot], gp_face3),button[islot,button_LT],keyboard_check(ord('U')));
button[islot,button_B] = max(gamepad_button_check(gamepad[islot], gp_face2),button[islot,button_RT],keyboard_check(ord('O')));
